...
export default class ProductQualifiedLeads extends Component {
    state = {
      ...
      handleClick = (e) => {
        ...
        if (this.state.newGraph === true){
            let reqObj = {
                ...
                body: JSON.stringify({
                    user_dashboards: {
                        dashboard_title: "Product Qualified Leads",
            ...
            let reqObj2 = {
                ...
                body: JSON.stringify({
                    kpi_data: {
                        kpi: "Product Qualified Leads",
                        data_point: this.state.pql ,
            ...
            <div>
                <div className= "muv_data_container">
                    ...
                    <h4>Select Quarter</h4>
                        ...
                        <Form.Field>
                            <h4>Product Qualified Leads This Month</h4>
                            <input placeholder='Product Qualified Leads' onChange= {this.handleChange} name= "pql" type= "number"/>
                        </Form.Field>
